...
function About() {
    return (
        <div data-aos="fade-left" className="overflow-hidden">
            ...
            <div className="grid  overflow-hidden lg:mx-20 lg:grid-cols-2 mt-36 md:grid-cols-1">
                <div className="bg-[#17C3B2] animate-pulse mt-16 lg:w-[500px] md:w-[200px] md:h-[200px] shadow-2xl mx-4 shadow-teal-700 lg:h-[500px] rounded-full">
                    <img 
