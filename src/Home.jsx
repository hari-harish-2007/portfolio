        ...
        <div data-aos="fade-right w-[100%] h-[100%] overflow-hidden">
            <div>
                ...
                <div className='grid overflow-x-[100%] md:mx-10 w-[100%] h-[100%] lg:grid-cols-2  md:grid-cols-1 '>
                    <div className=' w-[100%] mt-20 lg:mx-14 ml-10 h-[100%]'>
                        ...
                        <div className='flex gap-6 mt-12'>
                            <section>
                                <a
                                    ...
                                    class="group flex justify-center p-2 rounded-md drop-shadow-xl bg-[#17C3B2] text-white font-semibold hover:translate-y-2 transition-all duration-250 hover:from-[#331029] hover:to-[#310413]"
                                >
                                    <button class="flex items-center">
                                        ...
                                        <span class="absolute opacity-0 group-hover:opacity-100 group-hover:white group-hover:text-md group-hover:-translate-y-10 duration-500">
                                            WhatsApp
                                        </span>
                                    </button>
                                </a>
                            ...
                            <section class="flex justify-center items-center">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    class="group flex justify-center p-2 rounded-md drop-shadow-xl bg-[#17C3B2] text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
                                >
                                    <button class="flex items-center">
                ...
                Linkedin
                    ...
                    <div className="liquid overflow-hidden ">
                        <div className='lg:ml-40 -mt-2 md:ml-40  lg:w-[500px] '>
                            <img className='lg:w-[660px] w-[550px] h-[450px]  lg:h-[530px] relative   lg:-mb-60  ' src='/Assesst/happy-caucasian-male-graduate-graduation-glow-with-diploma-looking-camera-campus-removebg-preview.png' />
                        </div>
